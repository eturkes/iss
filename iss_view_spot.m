function iss_view_spot(o, FigNo, ScoreMethod, SpotNum)
    ...
    for r=1:o.nRounds
        ...
        for b=1:o.nBP
            ...
            z = round(GoodCorrectedYXZ(SpotNo,3,r,b));
            ...
            BaseIm = int16(imread(o.TileFiles{r,yTile,xTile,o.FirstBaseChannel + b - 1}, z, 'PixelRegion', {[y1 y2], [x1 x2]}))-o.TilePixelValueShift;
            if o.SmoothSize
    ...
    if ScoreMethod == 1
        ...
        figtitle.String = sprintf('Spot %.0f is %s: %s{%f %f %f}Score = %.1f, %s{%f %f %f}Score Deviation = %.1f, %s{%f %f %f}Intensity = %.0f',...
            SpotNo,o.GeneNames{o.pSpotCodeNo(SpotNo)},'\color[rgb]',c1,o.pSpotScore(SpotNo),'\color[rgb]',c2, o.SpotScoreDev(SpotNo),...
