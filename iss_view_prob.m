function SpotNo = iss_view_prob(o, FigNo, Norm, SpotNum)
    ...
    if isempty(o.cSpotAnchorChannel)
        ...
        figtitle.String = sprintf('%s{%f %f %f}Score = %.1f, %s{%f %f %f}LogProbOverBackground = %.0f, %s{%f %f %f}Score Deviation = %.1f, %s{%f %f %f}Intensity = %.0f, %s{%f %f %f}Spot SplitAnchor Channel = %.0f, %s SplitAnchor Channel = %.0f',...
            '\color[rgb]',c1,o.pSpotScore(SpotNo),'\color[rgb]',c2, o.pLogProbOverBackground(SpotNo),...
            '\color[rgb]',c3,o.pSpotScoreDev(SpotNo),'\color[rgb]',c4,o.pSpotIntensity(SpotNo),...
