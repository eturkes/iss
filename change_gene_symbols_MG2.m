function change_gene_symbols_MG2(MarkerSize, FontSize, MultiCol)
...
mg_light =  hsv2rgb([.55 1 1]);
mg2_light = hsv2rgb([.13 1 1]);
mg3_light = hsv2rgb([1 1 1]);
mg4_light = hsv2rgb([1/3 1 1]);
mg_dark =   hsv2rgb([.55 1 .5]);
mg2_dark =  hsv2rgb([.13 1 .5]);
mg3_dark =  hsv2rgb([1 1 .5]);
mg4_dark =  hsv2rgb([1/3 1 .5]);
