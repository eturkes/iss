function change_gene_symbols_allgenes_MG2(MarkerSize, FontSize, MultiCol)
...
in_all =     hsv2rgb([.57 1 .3]);
ex_all =     hsv2rgb([1/3 1 .3]);
non_neuron_all = hsv2rgb([.59 .1 .3]);

mg_light = hsv2rgb([.1 1 1]);
mg2_light =  hsv2rgb([.85 1 1]);
mg3_light = hsv2rgb([.15 1 1]);
mg4_light = hsv2rgb([1 1 1]);
mg_dark =  hsv2rgb([.1 .6 .5]);
